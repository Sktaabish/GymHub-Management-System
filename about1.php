...
<div class="about_wrapper">
      ...
      <nav>
        <div class="container">
          ...
          <ul>
            ...
            <li>
              <a class="active" href="about1.php">AboutUs</a>
            </li>
            <li>
  ...
  <div class="gym-info">
    ...
    <div class="abt">
      <p>
        When it comes to choosing the right gym for their fitness needs, people don’t look beyond Gym Hub. When it comes
        to making the right choice for your career, you shouldn’t look too hard either. At Gym Hub, we support a culture
        ...
        We believe in creating a work environment that mirrors our core values, of hard work, determination, excellence
